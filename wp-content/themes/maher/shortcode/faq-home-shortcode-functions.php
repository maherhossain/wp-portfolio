<?php
function faq_home_shortcode($atts)
{
  $atts = shortcode_atts(
    array(
      'post_type' => 'faq',
  ...
  ob_start();
?>
  <section id="faq-section" itemscope itemtype="https://schema.org/FAQPage" class="text-gray-600 <?php echo esc_html($atts['bg']); ?> body-font">
      ...
      <div class="grid pt-4 text-left border-t border-gray-200 md:gap-8 dark:border-gray-700 md:grid-cols-2">
        ...
        if ($faqs->have_posts()) :
          while ($faqs->have_posts()) : $faqs->the_post(); ?>
            <div class="mb-0 faq-container" itemprop="mainEntity">
...
add_shortcode('faq_home_shortcode', 'faq_home_shortcode');
