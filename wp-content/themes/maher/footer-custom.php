    ...
    <div
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="text-white hover:text-[#007bff]">Web Development</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">Ecommerce Development</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">WordPress Development</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">About</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">My Team</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">Testimonials</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">Portfolios</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">Frequently Asked Questions</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">Privacy Policy</a>
          </li>
          <li>
            <a class="text-white hover:text-[#007bff]">Terms and Conditions</a>
          </li>
        </nav>
      </div>
      <!-- Footer 2 -->
