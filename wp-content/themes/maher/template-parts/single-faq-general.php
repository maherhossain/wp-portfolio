<div
  ...
  <div class="flex flex-col lg:flex-row gap-4">
      ...
      <div class="bg-white">
        <div class="mx-auto max-w-screen-xl">
          ...
          <div class="flex flex-col text-left w-full sm:mb-20 mb-5">
            ...
            $content = str_replace('<p>', '<p class="leading-relaxed text-base lg:text-lg my-2 text-justify">', $content);
            echo $content;
            ?>
    ...
    <aside
      class="w-full lg:w-1/3 py-6 sm:py-8 lg:py-4 px-2 sm:px-2 lg:px-4 bg-red-100">
